...
const Footer = () => {
  return (
    <footer className="relative mt-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      {/* Efectos de fondo animados con colores unificados */}
      ...
      {/* Partículas decorativas con paleta unificada */}
      ...
      <div className="absolute top-16 left-1/4 w-3 h-3 bg-blue-300 rounded-full animate-pulse opacity-35"></div>
      ...
      <div className="relative container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center space-x-4 mb-4 group">
              ...
              {/* Logo con efectos 3D unificados */}
              <div className="relative">
                ...
                <div className="relative w-14 h-14 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-700 rounded-2xl flex items-center justify-center shadow-2xl transform transition duration-300 group-hover:scale-110 group-hover:rotate-12">
              ...
              <h3 className="text-3xl md:text-4xl font-black bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent tracking-tight">
                MasterCode Company
              </h3>
            </div>
            ...
            {/* Badges de características con colores unificados */}
          ...
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-3xl p-8 border border-slate-700/50 shadow-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="group flex flex-col items-center p-4 rounded-2xl bg-gradient-to-br from-blue-500/5 to-purple-500/5 border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300 transform hover:scale-105">
                <div className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full mb-3 group-hover:animate-pulse">
              ...
              {/* Contacto */}
              <div className="group flex flex-col items-center p-4 rounded-2xl bg-gradient-to-br from-green-500/5 to-green-600/5 border border-green-500/10 hover:border-green-500/30 transition-all duration-300 transform hover:scale-105">
                <div className="p-3 bg-gradient-to-r from-green-500 to-green-600 rounded-full mb-3 group-hover:animate-pulse">
                  <Mail className="text-white" size={20} />
                </div>
                <h5 className="text-white font-bold mb-1">Contacto</h5>
                <a 
                  href="mailto:mastercodecompany@gmail.com" 
                  className="text-slate-300 text-sm text-center hover:text-green-400 transition-colors duration-300 leading-relaxed break-all"
                >
              ...
              {/* Proyecto */}
              <div className="group flex flex-col items-center p-4 rounded-2xl bg-gradient-to-br from-purple-500/5 to-purple-600/5 border border-purple-500/10 hover:border-purple-500/30 transition-all duration-300 transform hover:scale-105">
                <div className="p-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full mb-3 group-hover:animate-pulse">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <button 
                ...
                className="group p-3 bg-slate-700 hover:bg-blue-600 rounded-full transition-all duration-300 transform hover:scale-110 hover:rotate-12"
              ...
              <button 
                ...
                className="group p-3 bg-slate-700 hover:bg-purple-600 rounded-full transition-all duration-300 transform hover:scale-110 hover:rotate-12"
        ...
        {/* Estadísticas del sistema con colores unificados */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="text-center p-4 bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-2xl border border-blue-500/20">
            <div className="text-2xl font-bold text-blue-400 mb-1">38</div>
            <div className="text-xs text-slate-400">Formularios</div>
          </div>
          <div className="text-center p-4 bg-gradient-to-br from-green-500/10 to-green-600/10 rounded-2xl border border-green-500/20">
          ...
          <div className="text-center p-4 bg-gradient-to-br from-blue-400/10 to-blue-500/10 rounded-2xl border border-blue-400/20">
            ...
            <div className="text-xs text-slate-400">Descargas</div>
          </div>
        </div>
